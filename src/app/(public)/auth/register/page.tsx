      ...
      <div className="backdrop-blur-xl bg-white/80 p-8 rounded-3xl border border-white/40 shadow-2xl transition-all duration-300 hover:shadow-blue-100/20">
        ...
        <div className="relative">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-500 text-sm font-medium">Tham gia cộng đồng học tiếng Nga đẳng cấp</p>
          </div>
          ...
          <div className="text-center mt-8">
            <p className="text-sm text-gray-600">
              Đã có tài khoản?{' '}
              <Link href="/auth/login" className="text-blue-600 hover:text-sky-400 font-medium transition-colors hover:underline">
                Đăng nhập
              </Link>
            </p>
          </div>
